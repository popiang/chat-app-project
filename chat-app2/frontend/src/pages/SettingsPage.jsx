...
// this is a sample chat messages to be used in the preview section when user select a theme
                            ...
                            <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                                ...
                                <div className="p-4 space-y-4 min-h-50 max-h-50 overflow-y-auto bg-base-100">
                                    {PREVIEW_MESSAGES.map((message) => (
                                        ...
                                        >
                                            <div
                                                className={`max-w-[80%] rounded-x p-3 shadow-sm ${message.isSent ? "bg-primary text-primary-consent" : "bg-base-200"}`}
                                            >
                                                <p className="text-sm">
                                                    {message.content}
                                                </p>
